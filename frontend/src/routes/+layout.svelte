...
<div class="app-container">
  <header class="sherlock-header">
    <nav>
      <a href="/" class="brand">
        <span class="brand-icon">&#128269;</span>
        <span class="brand-name">Sherlock Homes</span>
      </a>
      <ul class="nav-menu">
        <li><a href="/listings" class="nav-link">Browse</a></li>
  ...
  <footer class="sherlock-footer">
    <span class="footer-brand">Sherlock Homes</span>
    <span class="footer-divider">|</span>
    <span class="footer-tagline">Insight over inventory</span>
  </footer>
</div>

<style>
  /* Sherlock Homes Layout */
  .app-container {
    display: flex;
  ...
  /* Brand - Serif for authority */
  .brand {
    display: flex;
    align-items: center;
    gap: var(--space-2, 8px);
    text-decoration: none;
    transition: opacity 100ms var(--ease-out, ease-out);
  }
